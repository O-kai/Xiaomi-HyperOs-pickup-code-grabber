...
public class TestPlaceRegex {
    public static void main(String[] args) {
        String[] samples = {
            "【菜鸟驿站】测试包裹：取件码为99-9-1234，请到XX小区快递驿站门口取件（测试条目，可删除）",
        ...
        Pattern p1 = Pattern.compile("(?:到|在)([\\u4e00-\\u9fa5A-Za-z0-9]{2,30}?(?:店|站|柜|点|自提|快递))");
        Pattern p2 = Pattern.compile("(?:到|在)([\\u4e00-\\u9fa5A-Za-z0-9]{2,30}?(?:店|站|柜|点|自提|快递))(?=[，。,\\s取来领门]|$)");

        System.out.println("=== Pattern 1 (without lookahead) ===");
